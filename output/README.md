...
![Figure 2. Raw length versus raw width scatterplot](length_tenth_mm-vs-width_tenth_mm-scatter.png)
...
### Figure 3. Width Index Versus Height Index

![Figure 3. Width index versus height index](hindex_windex.png)
...
![Figure 5. Normalized height index by site](height_index_normalized-vs-site-boxplot.png)
...
![Figure 6. Normalized estimated surface area by site](est_surface_area_cm2_normalized-vs-site-boxplots.png)
...
![Figure 7. Normalized thermal dissipation index by site](thermal_dissipation_index_normalized-vs-site-boxplot.png)
...
### Figure 8 and Figure 9 Statistical Results

Linear models were made representing the relationship between thermal dissipation index and shelter distance, one accounting for interactions between sites (representing Figure 8) and one not accounting for interactions between sites (representing Figure 9). The ANOVA run on these models was non-significant (p = 0.9512), indicating that site interaction was non-significant.
While both linear models had significant p-values, both showed that shelter distance did not significantly influence thermal dissipation (p = 0.256863 and p = 0.31462 for the no interaction and interaction included models, respectively).
...
### Figure 10 and Figure 11 Statistical Results
...
![Figure 14. Surface area deviation by refuge availability](normalized_mean_surface_area_deviation-site.png)
...
![Figure 15. Raw shell PCA PC1 versus PC2](pca_1-2_shell_characters.png)
...
![Figure 16. Raw shell PCA PC1 versus PC3](pca_1-3_shell_characters.png)
...
![Figure 17. Raw shell PCA PC2 versus PC3](pca_2-3_shell_characters.png)
...
![Figure 18. Normalized shell PCA PC1 versus PC2](pca_1-2_normalized_shell_characters.png)
...
![Figure 19. Normalized shell PCA PC1 versus PC3](pca_1-3_normalized_shell_characters.png)
...
![Figure 20. Normalized shell PCA PC2 versus PC3](pca_2-3_normalized_shell_characters.png)
...
![Figure 21. Non-morphological PCA PC1 versus PC2](pca_1-2_non_morphological.png)
...
![Figure 22. Non-morphological PCA PC1 versus PC3](pca_1-3_non_morphological.png)
...
![Figure 23. Non-morphological PCA PC2 versus PC3](pca_2-3_non_morphological.png)
...
![Figure 24. Normalized thermal dissipation by individual ID](indiv_id-vs-thermal_dissipation_index_normalized.png)
...
![Figure 25. Normalized thermal dissipation scatterplot by individual ID](indiv_id-vs-thermal_dissipation_index_normalized-scatter.png)
...
![Figure 26. Normalized thermal dissipation versus distance to shelter](thermal_dissipation_index_normalized-dist_to_shelter-lin_mod.png)
